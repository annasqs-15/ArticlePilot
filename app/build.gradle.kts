...
android {
    namespace = "com.articlepilot.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.articlepilot.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
